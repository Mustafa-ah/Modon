...
{
    class CheckBoxMiniControl : ContentView
    {
        ...
        public CheckBoxMiniControl()
        {
            ...
            ContentGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(15) });
            ...
            SVGContainer.HeightRequest = 15;
            SVGContainer.WidthRequest = 15;
        ...
        public static BindableProperty CheckedProperty = BindableProperty.Create(
            ...
            declaringType: typeof(CheckBoxMiniControl),
            defaultValue: null,
...

        {
            ...
            set
            {
                SetValue(ImageUncheckProperty, value);
                OnPropertyChanged();
            }
        ...
        private static void CheckedValueChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (newValue != null && (Boolean)newValue == true)
                ((CheckBoxMiniControl)bindable).SVGContainer.Source = ((CheckBoxMiniControl)bindable).ImageChecked;
            else
                ((CheckBoxMiniControl)bindable).SVGContainer.Source = ((CheckBoxMiniControl)bindable).ImageUncheck;
        }
        ...
        {
            ((CheckBoxMiniControl)bindable).TextContainer.Text = (String)newValue;
        }
